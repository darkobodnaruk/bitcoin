...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 300; // 5 minutes
        ...
        genesis = CreateGenesisBlock(1231375067, 1337, 0x1f00ffff, 1, 100 * COIN);
        ...
        vSeeds.emplace_back("207.154.194.150"); //huzondok
        vSeeds.emplace_back("159.65.127.74"); //mantaglobb
